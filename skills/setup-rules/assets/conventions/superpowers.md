...
- Do not auto-invoke `using-superpowers`, `brainstorming`, `writing-plans`, `executing-plans`, `subagent-driven-development` or `test-driven-development` unless invoked by another skill; commit after manual invocation.
